...
const LeverQuestion: React.FC = () => {
  ...
  const questions = [
    ...
    {
      question: 'Watch the video and answer: Which planet is known as the Red Planet?',
      video: require('../videos/maintro.mp4'), // Đường dẫn đến video
  ...
  const nextQuestion = () => {
    if (currentQuestion < questions.length - 1) {
      ...
      Alert.alert(
        ...
        [{ text: 'OK', onPress: () => router.push('/level_course_content') }]
      );
    }
  };
